...
plot_neuron_subtypes <- function(
  ...
  pdf(file=paste0("figures/", data_type, "/", expr_type, "/neuronal_subtypes_mean_expr_dendrogram_", n_clusters, "_clusters_", data_type, "_", expr_type, "_", toupper(sim_type), "_", toupper(clust_method), "_", n_cts, "_CTs_", n_distinct(datinfo$Dataset), "_datasets_", n_genes, "_intersection_genes.pdf"), width=14, height=9)
