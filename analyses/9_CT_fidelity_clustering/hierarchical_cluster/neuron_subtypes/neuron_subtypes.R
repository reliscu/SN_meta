setwd("/home/rebecca/SCSN_meta_analysis/analyses/cortical_regions/9_CT_fidelity_clustering/hierarchical_cluster/neuron_subtypes")
...
plot_neuron_subtypes(ct_fid, datinfo, data_type, expr_type, which_genes, gene_list, sim_type, prop_metric, clust_method, top_n, ct_expr, n_clusters, neu_subtypes, prop_scaled)
