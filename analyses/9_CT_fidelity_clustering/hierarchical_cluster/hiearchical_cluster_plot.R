...
plot_dendro <- function(
  ...
  file_path <- paste0("figures/", data_type, "/", expr_type, "/CT_fidelity_dendrogram_", n_clusters, "_clusters_", data_type, "_", expr_type, "_", toupper(sim_type), "_", toupper(clust_method), "_", n_cts, "_CTs_", n_distinct(datinfo$Dataset), "_datasets_", n_genes, "_intersection_genes.pdf")
