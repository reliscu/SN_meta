setwd("/home/rebecca/SCSN_meta_analysis/analyses/cortical_regions/5_dataset_cell_class_mean_expr_clustering/hierarchical_cluster")
...
for(i in 1:length(expr_paths)){
  ...
  for(clust_method in c("complete", "ward.D2", "average")){
    plot_dendro(dataset_class_expr, datinfo, cell_class, data_type, expr_type, which_genes, gene_list, sim_type, prop_metric, clust_method, top_n)
  }
